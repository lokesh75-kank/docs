...
The warning applies to Anthropic and OpenAI models with a documented cache policy. Slash commands and programmatic prompts (for example, through [ACP](/oss/python/deepagents/acp)) never trigger the warning.
